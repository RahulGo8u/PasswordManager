    ...
    <div className="App">
      <Router>
        ...
        <Routes>
          <Route
            path="/"
            element={user ? <Navigate to="/userdetail" /> : <HomePage />}
          />
          <Route
            path="/passwords"
          ...
          <Route
            path="/add"
            element={<AddPassword onAddPassword={handleAddPassword} />}
          />
          <Route path="/login" element={<Login setJwtToken={setJwtToken} />} />
          <Route path="/register" element={<Register />} />
          <Route
            path="/userdetail"
            element={<UserDetail passwords={passwords} jwtToken={jwtToken} />}
          />
        </Routes>
        <Footer />
      </Router>
